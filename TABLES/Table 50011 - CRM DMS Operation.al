table 50011 "CRM DMS Operation"
{
    // Dynamics CRM Version: 9.2.21034.173

    Caption = 'Operación DMS';
    Description = '';
    ExternalName = 'auto_dmsoperation';
    TableType = CRM;

    fields
    {
        field(1;auto_dmsoperationId;Guid)
        {
            Caption = 'Operación DMS';
            Description = 'Identificador único de instancias de entidad';
            ExternalAccess = Insert;
            ExternalName = 'auto_dmsoperationid';
        ...
        {
            Caption = 'Estado';
            Description = 'Estado del Operación DMS';
        ...
        field(5;statuscode;Option)
        {
            ...
            Description = 'Razón para el estado del Operación DMS';
