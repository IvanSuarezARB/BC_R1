table 50006 "CRM Rel. Account Contact"
{
    // Dynamics CRM Version: 9.2.21034.173

    Caption = 'Relacion CuentaCliente Contacto';
    Description = 'Entidad que como único fin tiene relacionar las cuentas de cliente con los contactos mediante el CIF (autovatnum)';
    ExternalName = 'auto_relationaccountcontact';
    TableType = CRM;
    LookupPageId = "CRM Rel. Account Contact List";
    DrillDownPageId = "CRM Rel. Account Contact List";

    fields
    {
        field(1; auto_relationaccountcontactId; Guid)
        {
            Caption = 'Relacion CuentaCliente Contacto';
            Description = 'Identificador único de instancias de entidad';
            ExternalAccess = Insert;
            ExternalName = 'auto_relationaccountcontactid';
        ...
        {
            Caption = 'Estado';
            Description = 'Estado del Relacion CuentaCliente Contacto';
        ...
        field(5; statuscode; Option)
        {
            ...
            Description = 'Razón para el estado del Relacion CuentaCliente Contacto';
        ...
        field(12; auto_vatnum; Text[100])
        {
            Caption = 'Vatnum';
            Description = 'Cif Nif Dni';
    ...
    keys
    {
        key(Key1; auto_relationaccountcontactId)
        {
        }
        key(Key2; auto_name)
        {
