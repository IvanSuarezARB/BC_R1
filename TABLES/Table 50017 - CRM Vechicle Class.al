table 50017 "CRM Vechicle Class"
{
    // Dynamics CRM Version: 9.2.21034.173

    Caption = 'Clase de vehículo';
    Description = '';
    ExternalName = 'auto_vehicleclass';
    TableType = CRM;

    fields
    {
        field(1;auto_vehicleclassId;Guid)
        {
            Caption = 'Clase de vehículo';
            Description = 'Identificador único de instancias de entidad';
            ExternalAccess = Insert;
            ExternalName = 'auto_vehicleclassid';
        ...
        {
            Caption = 'Estado';
            Description = 'Estado del Clase de vehículo';
        ...
        field(5;statuscode;Option)
        {
            ...
            Description = 'Razón para el estado del Clase de vehículo';
