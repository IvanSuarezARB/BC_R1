table 50012 "CRM Usage Code"
{
    // Dynamics CRM Version: 9.2.21034.173

    Caption = 'Código utilización';
    Description = '';
    ExternalName = 'auto_usagecode';
    TableType = CRM;

    fields
    {
        field(1;auto_usagecodeId;Guid)
        {
            Caption = 'Código utilización';
            Description = 'Identificador único de instancias de entidad';
            ExternalAccess = Insert;
            ExternalName = 'auto_usagecodeid';
        ...
        {
            Caption = 'Estado';
            Description = 'Estado del Código utilización';
        ...
        field(5;statuscode;Option)
        {
            ...
            Description = 'Razón para el estado del Código utilización';
